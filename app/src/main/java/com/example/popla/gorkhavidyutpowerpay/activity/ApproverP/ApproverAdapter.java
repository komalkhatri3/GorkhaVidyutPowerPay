...
public class ApproverAdapter extends ArrayAdapter {
    List list=new ArrayList();
    private Context mcontext;

    public ApproverAdapter(@NonNull Context context, @LayoutRes int resource) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent)
    {
        ...
        handler.b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new  Intent(mcontext,ApproverAllDetail.class);
       ...
       /* handler.b1.setOnClickListener(new View.OnClickListener(){
        ...
        ApproverDataProvider dataProvider = (ApproverDataProvider) this.getItem(position);
        handler.Application_Id.setText(dataProvider.getApp_Id().toString());
